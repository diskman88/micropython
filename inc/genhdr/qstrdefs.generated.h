...
QDEF(MP_QSTR_bluebit, (const byte*)"\xc4\x07" "bluebit")
QDEF(MP_QSTR_set_mode, (const byte*)"\x3b\x08" "set_mode")
QDEF(MP_QSTR_mp3_init, (const byte*)"\xae\x08" "mp3_init")
QDEF(MP_QSTR_mp3_play, (const byte*)"\x90\x08" "mp3_play")
QDEF(MP_QSTR_mp3_stop, (const byte*)"\x2c\x08" "mp3_stop")
QDEF(MP_QSTR_mp3_volume, (const byte*)"\xdc\x0a" "mp3_volume")
QDEF(MP_QSTR_lcd_init, (const byte*)"\x2b\x08" "lcd_init")
QDEF(MP_QSTR_lcd_set_cursor, (const byte*)"\x66\x0e" "lcd_set_cursor")
QDEF(MP_QSTR_lcd_print, (const byte*)"\xa0\x09" "lcd_print")
QDEF(MP_QSTR_lcd_clear, (const byte*)"\xc8\x09" "lcd_clear")
QDEF(MP_QSTR_lcd_cmd, (const byte*)"\x9b\x07" "lcd_cmd")
QDEF(MP_QSTR_get_distance, (const byte*)"\xef\x0c" "get_distance")
QDEF(MP_QSTR_tm1650_init, (const byte*)"\x9b\x0b" "tm1650_init")
QDEF(MP_QSTR_tm1650_print, (const byte*)"\x50\x0c" "tm1650_print")
QDEF(MP_QSTR_tm1650_clear, (const byte*)"\x78\x0c" "tm1650_clear")
QDEF(MP_QSTR_get_color, (const byte*)"\x31\x09" "get_color")
QDEF(MP_QSTR_extIO_mode, (const byte*)"\x96\x0a" "extIO_mode")
QDEF(MP_QSTR_extIO_read, (const byte*)"\x07\x0a" "extIO_read")
QDEF(MP_QSTR_extIO_write, (const byte*)"\x28\x0b" "extIO_write")
QDEF(MP_QSTR_midi_init, (const byte*)"\xe9\x09" "midi_init")
QDEF(MP_QSTR_midi_set_volume, (const byte*)"\x86\x0f" "midi_set_volume")
QDEF(MP_QSTR_midi_set_instrument, (const byte*)"\xdb\x13" "midi_set_instrument")
QDEF(MP_QSTR_midi_note, (const byte*)"\x23\x09" "midi_note")
QDEF(MP_QSTR_matrix_init, (const byte*)"\x5b\x0b" "matrix_init")
QDEF(MP_QSTR_matrix_print, (const byte*)"\x90\x0c" "matrix_print")
QDEF(MP_QSTR_matrix_draw_bmp, (const byte*)"\xc1\x0f" "matrix_draw_bmp")
QDEF(MP_QSTR_matrix_draw_pixel, (const byte*)"\xf6\x11" "matrix_draw_pixel")
QDEF(MP_QSTR_matrix_clear, (const byte*)"\xb8\x0c" "matrix_clear")
QDEF(MP_QSTR_matrix_show, (const byte*)"\xc2\x0b" "matrix_show")
QDEF(MP_QSTR_get_ntc_temp, (const byte*)"\x26\x0c" "get_ntc_temp")
QDEF(MP_QSTR_get_sht20_temp, (const byte*)"\x72\x0e" "get_sht20_temp")
QDEF(MP_QSTR_get_sht20_humi, (const byte*)"\xe7\x0e" "get_sht20_humi")
QDEF(MP_QSTR_get_bh1750_light, (const byte*)"\xe4\x10" "get_bh1750_light")
QDEF(MP_QSTR_pca9685_init, (const byte*)"\xb0\x0c" "pca9685_init")
QDEF(MP_QSTR_pca9685_dc_motor, (const byte*)"\xb9\x10" "pca9685_dc_motor")
QDEF(MP_QSTR_pca9685_servo, (const byte*)"\xf7\x0d" "pca9685_servo")
QDEF(MP_QSTR_pca9685_set_pwm, (const byte*)"\x1d\x0f" "pca9685_set_pwm")
QDEF(MP_QSTR_pca9685_step_motor, (const byte*)"\x6c\x12" "pca9685_step_motor")
